package com.example.praktikum05.fragment;
...
import com.example.praktikum05.adapter.SearchAdapter;
import com.example.praktikum05.data.DataSource;
import com.example.praktikum05.Postingan;
import com.example.praktikum05.R;
import com.example.praktikum05.fragment.SearchFragment;
        ...
        searchView.setOnQueryTextListener(new androidx.appcompat.widget.SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                executor.execute(() -> {
                    ...
                    if (!newText.isEmpty()) {
                        for (Postingan item : DataSource.instagrams) {
