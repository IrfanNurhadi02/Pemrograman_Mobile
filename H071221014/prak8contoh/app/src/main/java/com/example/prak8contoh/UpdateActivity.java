...
public class UpdateActivity extends AppCompatActivity {
    ...
    private void loadRecordData(int id) {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            et_UpdateJudul.setText(cursor.getString(cursor.getColumnIndexOrThrow(dbConfig.getColumnTitle())));
            et_UpdateDeskripsi.setText(cursor.getString(cursor.getColumnIndexOrThrow(dbConfig.getColumnDescription())));
            cursor.close();
        }
    }
