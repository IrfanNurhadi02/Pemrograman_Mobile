...
public class PostinganFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_posting.setOnClickListener(btn ->{
            ...
            if (konten.isEmpty()){
                Toast.makeText(getActivity(), "Isi konten", Toast.LENGTH_SHORT).show();
            } else if (selectedImageUri == null) {
                Toast.makeText(getActivity(), "Pilih gambar terlebih dahulu", Toast.LENGTH_SHORT).show();
            } else {
                Instagram instagram = new Instagram("sipalingmarvel", "marvel", konten, R.drawable.marvel, selectedImageUri);
