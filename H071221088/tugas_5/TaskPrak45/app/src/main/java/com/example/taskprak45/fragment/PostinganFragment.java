package com.example.taskprak45.fragment;
...
import com.example.taskprak45.Instagram;
import com.example.taskprak45.R;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_posting.setOnClickListener(btn ->{
            ...
            if (konten.isEmpty()) {
                ...
                Instagram instagram = new Instagram("Fauzan Baihaqi", "Fauzan", konten, R.drawable.profil1, selectedImageUri);
